  ...
  return (
    <div aria-hidden="true" className="relative h-full overflow-hidden">
      ...
      <div className="absolute left-1/2 h-full w-[26rem] -translate-x-1/2">
        <MainLogo />
        <Logo
          src="https://upload.wikimedia.org/wikipedia/pt/2/22/Logo_do_Banco_Next.svg"
          left={285}
          top={20}
          hover={{ x: 4, y: -5, rotate: 6, delay: 0.3 }}
        />
        <Logo
          src="https://cdn.icon-icons.com/icons2/2622/PNG/512/brand_disney_icon_158933.png"
          left={255}
          top={210}
          hover={{ x: 3, y: 5, rotate: 7, delay: 0.2 }}
        />
        <Logo
          src="https://cdn-icons-png.flaticon.com/512/871/871394.png"
          left={144}
          top={40}
        ...
        />
        <Logo
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEZ0GaIldTaOT1-RCwrg7-eIoZwfxDYl-sZw&s"
          left={96}
          top={176}
